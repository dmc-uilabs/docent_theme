...
<body>
	...
	<div class="review-block">
		<a href="#">Is the stability of all sole/single/foreign sources and obsolescence issues being assessed/monitored?</a>
	...
	<div class="review-block">
		<a href="#">Are the necessary alternatives to sole/single/foreign sources being developed?</a>
		<div class="status-no">No</div>
	</div>

	<div class="review-block">
		<a href="#">Have the required manufacturing science and manufacturing technology development solutions been demonstrated in a production representative environment?</a>
	...
	<div class="review-block">
		<a href="#">Are the producibility enhancement efforts (e.g., Design For Manufacturing and Design for Assembly) ongoing for an optimized integrated system?</a>
